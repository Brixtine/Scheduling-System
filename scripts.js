const MAX_STUDENTS_PER_SECTION = 40;
        ...
        function showStudentSchedule(studentId) {
            ...
            if (sectionSchedule) {
                ...
                sectionSchedule.sort((a, b) => {
                    ...
                    return timeSlots.indexOf(timeA + " " + a.time.split(" ")[2] + " " + a.time.split(" ")[3]) - 
                           timeSlots.indexOf(timeB + " " + b.time.split(" ")[2] + " " + b.time.split(" ")[3]);
                });
        ...
        function assignSubjectToSection(section, subject, roomType, professor, hours) {
            ...
            while (assignedHours < hours && maxAttempts > 0) {
